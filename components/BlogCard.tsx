...
import { ArrowRight, Edit } from "iconsax-reactjs";
...
export default function BlogCard({ item }: Props) {
  ...
  return (
    ...
    >
      <div
        ref={cardRef}
        className="w-full group flex justify-between items-center dark:hover:bg-gray-500 hover:bg-gray-300 rounded-md hover:bg-opacity-5 transition-colors p-1 pr-0 md:pr-4"
      >
